class Rotor(object):
    """Class representing the rotor variabels allowing grid
    design estimations to be made for a rotor case.
    """
    ...
    def __init__(self):
        ...
        # Rotor
        self._tip_speed = None          # Velocity [Lunit/Tunit]
        self._tip_speed_ = None         # Internal
        self._radius = None     # Radius of rotor [Lunit]
        self._radius_ = None    # Internal
        self._rpm = None     # Rotor rpm [/Tunit]
        self._rpm_ = None    # Internal
        self._number_of_revolutions = None     # Number of revolutions for interval []
        self._number_of_revolutions_ = None    # Internal
